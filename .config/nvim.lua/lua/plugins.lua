...
packer.startup(function(use)
    ...
    use('rafi/awesome-vim-colorschemes')                        -- Retro colorschemes
    use('ap/vim-css-color')                                     -- CSS Color Preview
    -- use('yamatsum/nvim-cursorline')                             -- Highlighting the word references under cursor
    use('itchyny/vim-cursorword')                               -- vim-hightlight_under_cursor
    ...
    use('ntpeters/vim-better-whitespace')                       -- Trim Whitespace Plugin
